  ...
  return (
    <>
            <div className={"flex justify-between gap-[24px] pt-[8px] px-[12px] pb-[16px]"}>
               <DataCard styles={"w-full"} title={"Total Referral Earnings"} count={300000} isPrice={true}/>
               <DataCard styles={"w-full"} title={"Total Number of Referrers"} count={200}/>
               <DataCard styles={"w-full"} title={"Total Number of Referrals"} count={500}/>
            </div>
                ...
                <div className='flex flex-col border-[1px] border-yellow-accent-3 rounded-[12px] h-fit'>
                    <div className='w-[326px] h-[48px] bg-yellow-accent-1 rounded-tl-[12px] rounded-tr-[12px]'>
                        <div className='flex items-center px-[24px] py-[16px]'>
                            <p className='font-semibold text-[12px] text-light-black'>Top 5 Referrers</p>
                        </div>
                    </div>
