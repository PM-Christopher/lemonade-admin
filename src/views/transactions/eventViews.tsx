        ...
        <>
            ...
            <div className="bg-white shadow-md rounded-lg">
                <table className="min-w-full table-auto border-collapse">
                    ...
                    <tbody>
                    {
                        paginatedData && paginatedData.length > 0 ? paginatedData.map((row:Event, index: number) => (
                            <tr key={index} className="border-b border-grey-20 h-[72px] cursor-pointer" onClick={() => router.push(`/transactions/${row.id}/event-details`)}>
