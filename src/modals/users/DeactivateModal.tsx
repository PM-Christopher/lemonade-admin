      ...
      <div className="w-[360px] bg-white pt-[16px] pb-[4px] rounded-[12px]">
        ...
        <div className={"py-[16px] flex flex-col gap-[16px] px-[16px]"}>
          <p className={"text-[14px] font-normal text-light-black"}>
            Are you sure you want to deactivate this user? This user account and
            all activities related to it will be permanently removed on the
            platform
          </p>
          ...
          <div className={"flex justify-between gap-[10px]"}>
            ...
            <button
              className={
                "h-[48px] border-[1px] bg-red-1 border-red-2 py-[14px] rounded-[12px] w-[156px] text-center"
              }
